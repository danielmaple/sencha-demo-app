...
folder are mapped to the application's root namespace, 'SenchaDemoApp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SenchaDemoApp' in the same way
as `"SenchaDemoApp/sass/src"`.
